...
Public Class SingleValidation
    ...
    Public Function DisposableEmail(ByVal email As String) As MBVResult
        Dim record As MBVResult = New MBVResult(email)
        ...
        request = Net.WebRequest.Create("http://api.mailboxvalidator.com/v1/email/disposable?" & datastr.TrimStart("&"))
    ...
    Public Function FreeEmail(ByVal email As String) As MBVResult
        Dim record As MBVResult = New MBVResult(email)
        ...
        request = Net.WebRequest.Create("http://api.mailboxvalidator.com/v1/email/free?" & datastr.TrimStart("&"))
